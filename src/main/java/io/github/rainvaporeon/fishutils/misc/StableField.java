...
import io.github.rainvaporeon.fishutils.internal.UtilityAccess;
...
public class StableField<T> implements Serializable, Cloneable {
    ...
    /**
     * Creates a stable field with the default value as the value provided.
     *
     * @param t the value
     */
    ...
    /**
     * Checks whether this field was modified before. If yes, subsequent calls to {@link
     * StableField#set(Object)} will throw an exception.
     *
    ...
    /**
     * Checks whether the two objects are equal. This may return true if the underlying object's
     * {@code equals} method returns true.
     *
     * @param object the object to compare to
     * @return true if this object's underlying object is identical to the other, or if both stable
     *     fields hold the same object
     */
    @Override
    @DelegatesToShadow
        ...
        if (t instanceof Cloneable) {
            try /* evil dark magic */ {
                ...
                throw new AssertionError(
                        "clone failed on cloneable type " + t.getClass().getName() + ": ", ex);
            }
        } else {
            throw new RuntimeException(
                    "calling clone to non-cloneable type " + t.getClass().getName());
        }
    }
