...
public abstract class ExecutionNode<T> {
    ...
    /**
     * Retrieves the result, may interrupt if the value is not ready, may throw an {@link
     * IllegalStateException} if {@link ExecutionNode#run()} is not previously called.
     *
     * @return the result
    ...
    /**
     * Executes the action on this node. After call to this method, {@link ExecutionNode#get()} may
     * return a {@link Future} denoting the outcome.
     */
