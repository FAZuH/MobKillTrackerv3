...
public class CollectionMisc {
     ...
     * @apiNote This method is implemented in a way so that if a collection is completely sorted, it
     *     returns 0, otherwise, returns the tendency of this collection
     */
    @Beta
