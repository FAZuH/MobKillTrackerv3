package io.github.rainvaporeon.fishutils.tests;

import io.github.rainvaporeon.fishutils.misc.ThrowingRunnable;

public interface TestComponent<T> extends TestInstruction<T> {
    /**
     * Executes this test, this works same as calling the underlying method with the supplied
     * parameters.
     *
    ...
    /**
     * Performs an action if the previous condition fails, must be chained after an assertion
     * statement
     *
