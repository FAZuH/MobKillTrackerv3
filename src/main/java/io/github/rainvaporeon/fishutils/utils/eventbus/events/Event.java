...
import io.github.rainvaporeon.fishutils.utils.eventbus.Secret;
...
public abstract class Event {
    /**
     * The event buses' signatures, to prevent the same event from arriving to a bus multiple times
     */
