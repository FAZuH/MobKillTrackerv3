 ...
 *
 * <p>This class behaves nearly identical to the default implementation, but with {@link
 * CancellableEventBus#fireCancellable(Event)} to fire events that listeners can return {@code true}
 * to cancel it half-way.
 *
 * @since 1.2.19
 */
