...
/**
 * Thrown when the subscribing object to {@link EventBus} has mismatching types (that is, the
 * parameter is not an instance of {@link Event}), or if the object does not contain any subscriber
 * methods.
 */
